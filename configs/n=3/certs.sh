...
cp $CERTS_DIR/peer2.crt /peer2-certs/peer2.crt
cp $CERTS_DIR/peer2.key /peer2-certs/peer2.key
cp $CERTS_DIR/ca.crt /peer2-certs/ca.crt

cp $CERTS_DIR/peer3.crt /peer3-certs/peer3.crt
